...
if __name__ == "__main__":
    ...
    transformer1 = nn.Transformer(d_model = 512, nhead = 8, num_encoder_layers=6, num_decoder_layers=6)
    transformer2 = nn.Transformer(d_model = 512, nhead=8, num_encoder_layers=6, num_decoder_layers=6)
